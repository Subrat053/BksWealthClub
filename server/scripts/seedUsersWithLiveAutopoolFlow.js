...
async function run() {
  try {
    ...
    let count = 250; // Default count if none is specified
    ...
    console.log("================================================================");
    console.log(`🚀 STARTING SEQUENTIAL USER SEEDING PROCESS: Seeding ${count} Users`);
    console.log(`   Real Live Autopool FIFO Flow (Ensuring Node-by-Node stabilization)`);
    console.log("================================================================");
    ...
    for (let i = 1; i <= count; i++) {
      ...
      while (retryCount < maxRetries && !success) {
        ...
        try {
          ...
          // 2. Trigger standard autopool activation (Creates 2 Rebirth nodes)
          ...
          // 4. Critical: Process and stabilize Autopool fully before moving to next user in sequence!
          await ensureAutopoolQueueUnlocked();
          console.log(`   ⚙️ Stabilizing autopool tree for ${memberId}...`);
    ...
    console.log("   All users are active and the autopool remains fully stable.");
    console.log("================================================================");
