...
const faqs = [
  ...
  "How can I get started with bkswealthclub ?",
];
...
export default function HomePage() {
  return (
    <div className="lg:space-y-0">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          >
            ...
            <p className="mt-5 text-base leading-8 text-slate-600">
              ...
              This is a community building platform using an automation pool,
              and the history of network marketing is being revolutionized to
              the market.
            </p>
            ...
            <div className="mt-8 space-y-5">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-slate-600">
                    We build trust by delivering consistent gains from a
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-slate-600">
                    The first platform using many account multiplication
                    strategy.
                  </p>
                </div>
              </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_1fr] lg:px-8">
          ...
          >
            ...
            <h3 className="mt-4 text-4xl font-extrabold leading-none text-slate-900 sm:text-6xl">
              It is the first platform that we have been using the strategy of
              multiplying many accounts
            </h3>
      ...
      <section
        id="projects"
        className="relative overflow-hidden bg-[#021533] py-20 text-white"
      >
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          >
            ...
            <p className="mt-5 text-base leading-8 text-slate-300">
              ...
              astonishes everybody. Here is the chance to fulfill your and your
              dear ones dreams.
            </p>
          ...
          >
            ...
            <div className="relative rounded-[30px] bg-white p-8 shadow-[0_22px_55px_rgba(2,21,51,0.12)] ring-1 ring-slate-100">
              ...
              <p className="mt-2 text-slate-500">
                Get in touch with bkswealthclub — we are here to assist you.
              </p>
