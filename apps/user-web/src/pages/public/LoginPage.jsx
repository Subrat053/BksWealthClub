...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto lg:mx-auto max-w-2xl lg:m-12">
      <Card title="Member Login" className="overflow-hidden bg-[linear-gradient(160deg,#040a27_0%,#08133a_55%,#102567_100%)] p-0">
        <div className="grid gap-6 p-6 md:grid-cols-[1.1fr_1fr] md:p-8">
          <div>
            ...
            <p className="mt-2 text-md text-slate-300">Login to access your member dashboard, team, incomes, and withdrawal controls.</p>
          ...
          <FormField label="Username or BEP20 Address">
            <input
              value={form.username}
          ...
          <p className="text-sm text-slate-300">
            Need an account? <Link to="/register" className="text-white underline">Register here</Link>
          </p>
          </form>
        </div>
      </Card>
